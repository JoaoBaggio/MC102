...
#!/bin/bash
# autor: Vina 16/05/2017, nao do JaoJao
...
# Verifica se o Usuario possui o comando curl  instaldo
    ...
    curl https://susy.ic.unicamp.br:9999/mc102abcd/$num/dados/$arq.in --insecure -O -s 
    curl https://susy.ic.unicamp.br:9999/mc102abcd/$num/dados/$arq.res --insecure -O -s 
    PARADA=""
...
then
    ...
    trap 'rm nohup* -f ;ls; exit' 0 1 2 3 15  
        nohup firefox https://susy.ic.unicamp.br:9999/mc102abcd/$num & > /dev/null
        rm nohup.out -f
        clear
    fi
else
